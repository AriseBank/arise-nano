...
describe('PricedButton', () => {
  ...
  describe('Sufficient funds', () => {
    ...
    it('renders a span saying "Fee: 5 ACO"', () => {
      expect(wrapper.find('span').text()).to.be.equal('Fee: 5 ACO');
    });
  ...
  describe('Insufficient funds', () => {
    ...
    it('renders a span saying "Insufficient funds for 5 ACO fee"', () => {
      expect(wrapper.find('span').text()).to.be.equal('Insufficient funds for 5 ACO fee');
    });
