...
import AriseAmount from '../ariseAmount';
        ...
        <Table selectable={false}>
          ...
          {props.forgedBlocks.map((block, idx) => (
            <TableRow key={idx}>
              ...
              <TableCell><AriseAmount val={block.totalFee} roundTo={2} /></TableCell>
              <TableCell><AriseAmount val={block.reward} roundTo={2} /></TableCell>
            </TableRow>
          ))}
        </Table>
      </div> :
