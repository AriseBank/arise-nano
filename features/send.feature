Feature: Send dialog
  Scenario: should allow to send when enough funds and correct address form
    ...
    Then I should see alert dialog with title "Success" and text "Your transaction of 1 ACO to 537318935439898807L was accepted and will be processed in a few seconds."
  ...
  Scenario: should allow to send all funds 
    ...
    And I click "submit button"
    Then I should see alert dialog with title "Success" and text "Your transaction of 101 ACO to 537318935439898807L was accepted and will be processed in a few seconds."
