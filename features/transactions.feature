Feature: Transactions tab
  ...
  Scenario: should allow send to address
    ...
    Then I should see alert dialog with title "Success" and text "Your transaction of 100 ACO to 537318935439898807L was accepted and will be processed in a few seconds."
